...
You will need a private registry where the NDK images have to be pushed to. Ensure you have [Docker Engine](https://docs.docker.com/engine/install/) and [helm](https://helm.sh/docs/intro/install/) installed in your jumphost.
